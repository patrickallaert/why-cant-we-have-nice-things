...
abstract class TestCase extends PHPUnit_Framework_TestCase
{
     ...
     * @param array $actual
     */
    protected function assertEqualsPartially(array $expected, array $actual)
    {
        $intersect = array_intersect_key($expected, $actual);
        $actual = array_only($actual, array_keys($intersect));
